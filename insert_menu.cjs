...
const content = `                {adminTab === 'menu' && (userRole === 'superadmin' || userRole === 'admin') && (
                        ...
                        <form onSubmit={handleCreateDishSubmit} className="bg-emerald-50/50 border border-emerald-100 p-5 rounded-xl mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="md:col-span-2">
                            ...
                            <input
                              ...
                              required
                              className="w-full p-2 bg-white border border-gray-200 rounded-lg text-xs focus:ring-1 focus:ring-emerald-500 focus:outline-hidden"
                            />
                          </div>
                          <div>
                            ...
                            <select
                              ...
                              className="w-full p-2 bg-white border border-gray-200 rounded-lg text-xs focus:outline-hidden"
                            >
                          ...
                          <div className="md:col-span-3 flex justify-end">
                            <button
                              type="submit"
                              className="px-4 py-2 bg-emerald-600 text-white rounded-lg text-xs font-bold hover:bg-emerald-700 shadow-xs"
                            >
                              Guardar en Menú
                            </button>
                          </div>
                                ...
                                {dishForm.image && dishForm.image.trim() !== '' ? (
                                  <div className="relative group">
                                    <img
                                      ...
                                      className="w-16 h-16 rounded-xl object-cover border border-amber-200 shadow-xs"
                                    />
                                    <button
                                      type="button"
                                  ...
                                  <div className="flex items-center gap-2">
                                    <div className="w-16 h-16 rounded-xl bg-amber-100 text-amber-900 border border-amber-300 font-black text-base flex items-center justify-center uppercase tracking-wider select-none shadow-2xs">
                          ...
                          <div
                            ...
                            className={\`p-3.5 border rounded-2xl bg-white transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 \${
                              draggedDishIndex === index
                                ...
                                : 'border-gray-200/80 hover:border-amber-200 hover:shadow-xs'
                            }\`}
                          >
                            <div className="flex items-center gap-3">
                              {/* Drag Handle */}
                              ...
                              {item.image && item.image.trim() !== '' ? (
                                <img
                                  src={item.image}
                                  alt={item.name}
                                  className="w-12 h-12 rounded-xl object-cover border border-amber-100 shadow-2xs shrink-0"
                                />
                              ) : (
                                <div
                                  className="w-12 h-12 rounded-xl bg-amber-100 text-amber-900 border border-amber-300 font-black text-sm flex items-center justify-center uppercase tracking-wider shrink-0 select-none shadow-2xs"
...
const insertIndex = lines.findIndex(line => line.includes('adminTab === \'perfil\'')) - 1; // Before the {adminTab === 'perfil'}
